...
public class PinputView extends androidx.appcompat.widget.AppCompatTextView {
    public static final int VIBRATE_LENGTH_DEFAULT = 350;
    ...
    private void initializeAnimator() {
        post(new Runnable() {
            ...
            public void run() {
                ...
                mErrorAnimator.setInterpolator(new CycleInterpolator(5));
