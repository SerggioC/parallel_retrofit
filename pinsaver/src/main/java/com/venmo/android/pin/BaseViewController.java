...
abstract class BaseViewController<T extends PinFragmentImplement> {
    ...
    private void init() {
        mPinputView = mRootView.findViewById(R.id.pin_pinputview);
        mKeyboardView = mRootView.findViewById(R.id.pin_keyboard);
        mProgressBar = mRootView.findViewById(R.id.pin_progress_spinner);
        mHeaderText = mRootView.findViewById(R.id.pin_header_label);
        initKeyboard();
        initUI();
